...
let favoriteFoods = ['cherries', 'lasagna', 'chicken wings'];
...
console.log('Second animal is', animalArray.length);
...
favoriteFoods.push('pineapples');
console.log('Added another faorite food,' favoriteFoods);
